...
namespace System.Collections.Immutable.Tests
{
    public class ImmutableArrayTest : SimpleElementImmutablesTestBase
    {
        ...
        public void Equals0(StrongBox<ImmutableArray<int>> firstBox, StrongBox<ImmutableArray<int>> secondBox, bool expected)
        {
...
#pragma warning restore CS1718 // Comparison made to same variable
        ...
        [MemberData(nameof(StrongBoxedInt32EnumerableData))]
        [MemberData(nameof(StrongBoxedSpecialInt32ImmutableArrayData))]
        public void GetHashCode1(StrongBox<IEnumerable<int>> box)
        {
            IEnumerable<int> source = box.Value;
            var array = source.ToImmutableArray();
