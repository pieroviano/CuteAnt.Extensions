...
namespace System.Text.Claims
{
    ...
    public class ClaimsIdentity : IIdentity
    {
        ...
        public ClaimsIdentity(IIdentity identity, IEnumerable<Claim> claims, string authenticationType, string nameType, string roleType)
        {
            ...
            if (claimsIdentity != null)
            {
                ...
                if (claimsIdentity.Actor != null)
                {
                    ...
                    {
                        throw new InvalidOperationException("Actor cannot be set so that circular directed graph will exist chaining the subjects together.");
                    }
                }
        ...
        private void OnSerializingMethod(StreamingContext context)
        {
            ...
            {
                throw new PlatformNotSupportedException("This instance contains state that cannot be serialized and deserialized on this platform."); // BinaryFormatter would be needed
            }
        }
        ...
        protected virtual void GetObjectData(SerializationInfo info, StreamingContext context)
        {
            ...
            {
                throw new PlatformNotSupportedException("This instance contains state that cannot be serialized and deserialized on this platform."); // BinaryFormatter needed
            }
        }
