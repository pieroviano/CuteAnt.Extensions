...
{
    /// <summary>A set of elements that can only be modified by creating a new instance of the set.</summary>
    ...
    {
        /// <summary>Gets an empty set that retains the same sort or unordered semantics that this instance has.</summary>
        [Pure]
        IImmutableSet<T> Clear();

        /// <summary>Determines whether this set contains the specified value.</summary>
        ...
        /// <summary>Adds the specified value to this set.</summary>
        ...
        /// <summary>Removes the specified value from this set.</summary>
        ...
        /// <summary>Produces a set that contains elements that exist in both this set and the specified set.</summary>
        ...
        /// <summary>Removes a given set of items from this set.</summary>
        ...
        /// <summary>Adds a given set of items to this set.</summary>
