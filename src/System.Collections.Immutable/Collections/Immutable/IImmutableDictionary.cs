...
namespace System.Collections.Immutable
{
    ...
    {
        /// <summary>Gets an empty dictionary with equivalent ordering and key/value comparison rules.</summary>
        [Pure]
        ...
        /// <summary>Sets the specified key and value to the dictionary, possibly overwriting an existing value for the given key.</summary>
        /// <param name="key">The key of the entry to add.</param>
        /// <param name="value">The value of the entry to add.</param>
        /// <returns>The new dictionary containing the additional key-value pair.</returns>
        /// <remarks>
        ...
        /// <summary>Removes the specified keys from the dictionary with their associated values.</summary>
        ...
        /// <summary>Removes the specified key from the dictionary with its associated value.</summary>
        ...
        /// <summary>Determines whether this dictionary contains the specified key-value pair.</summary>
