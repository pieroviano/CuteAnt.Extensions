...
namespace System.Collections.Immutable
{
    ...
    {
        /// <summary>Gets the depth of the tree below this node.</summary>
        int Height { get; }

        /// <summary>Gets a value indicating whether this node is empty.</summary>
        bool IsEmpty { get; }

        /// <summary>Gets the number of non-empty nodes at this node and below.</summary>
